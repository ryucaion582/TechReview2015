...
using DemoWebApp2015TechReview.Models;

namespace DemoWebApp2015TechReview.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override void BuildModel(ModelBuilder builder)
        {
            ...
            builder.Entity("DemoWebApp2015TechReview.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("DemoWebApp2015TechReview.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
